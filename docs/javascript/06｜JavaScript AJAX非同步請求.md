---
title: 06｜ JavaScript AJAX非同步請求
sidebar_position: 7
tags: [JavaScript, 課程筆記, 知識點筆記]
date: 2025-10-17
slug: /docs/javascript/js-ajax-async-requests
---
...
#### 2. 客戶端與伺服器資料交換的過程
    ...
    ![網路請求交換流程](/img/js06-1.png)

- **以「進入 Google 頁面」為例**：

  ![Google首頁載入過程](/img/js06-2.png)
