...
![DOM 節點樹狀圖](/img/截圖 2025-10-12 晚上9.25.34.png)
...
| 方法 / 屬性 | 說明 | 範例 |
| --- | --- | --- |
| `getElementById()` | 透過 id 選取元素（HTMLCollection） | `document.getElementById('myDiv')` |
| `getElementsByClassName()` | 透過 class 選取元素集合（HTMLCollection） | `document.getElementsByClassName('item')` |
| `getElementsByTagName()` | 透過標籤選取元素集合（HTMLCollection） | `document.getElementsByTagName('p')` |
| `querySelector()` | CSS 選擇器選取第一個元素 | `document.querySelector('.item')` |
| `querySelectorAll()` | CSS 選擇器選取**所有**符合元素（NodeList） | `document.querySelectorAll('div.item')` |
| `innerHTML` | 取得或修改 HTML 內容 | `div.innerHTML = '<p>Hello</p>'` |
| `textContent` | 取得或修改文字內容 | `div.textContent = 'Hello'` |
| `style` | 修改元素樣式 | `div.style.color = 'red'` |
| `classList` | 操作 class | `div.classList.add('active')` |

- **DOM 選取回傳類型範例圖**：
  - `getElementById()`：
    ![getElementById 回傳範例](/img/截圖 2025-10-10 晚上9.49.44.png)
  - `getElementsByClassName()`：
    ![getElementsByClassName 回傳範例](/img/截圖 2025-10-10 晚上9.45.37.png)
  - `getElementsByTagName()`：
    ![getElementsByTagName 回傳範例](/img/截圖 2025-10-10 晚上9.47.47.png)
  - `querySelectorAll()`：
    ![querySelectorAll 回傳範例](/img/截圖 2025-10-10 晚上9.52.13.png)
